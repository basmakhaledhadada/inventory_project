...
{
    class StockPermission : UserDecorator
    {
        public int id;
        Boolean[] p = new Boolean[4];
        public string sql;
        public StockPermission(IPermission userpermission , Boolean[] p) : base(userpermission)
        {
            this.p = p;
        }
        ...
        public override void delete()
        {
            ...
            if (this.p[3] == true)
            {
                ...
                cmd.Parameters.AddWithValue("roll_id", "stock_delete");
        ...
        public override void insert()
        {
            if (this.p[1] == true)
            {
                ...
                MySqlCommand cmd = new MySqlCommand(sql, DBconn.Connection);
                cmd.Parameters.AddWithValue("user_id", this.id);
                cmd.Parameters.AddWithValue("roll_id", "stock_insert");
                cmd.Parameters.AddWithValue("type", "stock");
                cmd.ExecuteNonQuery();
                sql = "";
            }
        ...
        public override void update()
        {
            if (this.p[2] == true)
            {
                ...
                MySqlCommand cmd = new MySqlCommand(sql, DBconn.Connection);
                cmd.Parameters.AddWithValue("user_id", this.id);
                cmd.Parameters.AddWithValue("roll_id", "stock_update");
                cmd.Parameters.AddWithValue("type", "stock");
                cmd.ExecuteNonQuery();
                sql = "";
            }
        ...
        public override void viewOnly()
        {
            if (this.p[0] == true)
            {
                ...
                MySqlCommand cmd = new MySqlCommand(sql, DBconn.Connection);
                cmd.Parameters.AddWithValue("user_id", this.id);
                cmd.Parameters.AddWithValue("roll_id", "stock_viewonly");
                cmd.Parameters.AddWithValue("type", "stock");
                cmd.ExecuteNonQuery();
                sql = "";
            }
